From last time, I managed somehow to make the poll work again. I think the problem was that i did not do npm run build and copy the files after editing the files, but I am not 100% sure. 
